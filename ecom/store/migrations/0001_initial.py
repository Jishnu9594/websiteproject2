# Generated by Django 4.1.7 on 2023-04-18 14:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Order', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.customer')),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='store.ShippingAddress.customer +', to='store.customer')),
            ],
        ),
        migrations.CreateModel(
            name='OrderItem',
